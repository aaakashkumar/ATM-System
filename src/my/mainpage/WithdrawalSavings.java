 ...
 * @author Akash Kumar
 */
public class WithdrawalSavings extends javax.swing.JFrame {
    private String amount, cardNumber;
    private int balance;
    
    /** Creates new form WithdrawalSavings */
    public WithdrawalSavings() {
        initComponents();
    }
    public WithdrawalSavings(String cardNumber) {
        initComponents();
        amount = "";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(WithdrawalSavings.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new WithdrawalSavings().setVisible(true);
            }
        });
    }
