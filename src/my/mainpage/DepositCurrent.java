...
public class DepositCurrent extends javax.swing.JFrame {
    ...
    private int balance;
    /**
     * Creates new form DepositCurrent
     */
    ...
    public DepositCurrent(String cardNumber) {
        initComponents();
        amount = "";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DepositCurrent.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DepositCurrent().setVisible(true);
            }
        });
    }
